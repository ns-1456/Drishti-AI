#!/usr/bin/env python3
"""
Sanity check: download last 7 days of NO2, CO, and Aerosol Index for Delhi NCR from GEE.
Run after: earthengine authenticate
Saves (7, 3, 64, 64) to data/satellite/ncr_7d.pt
"""
...
def main():
    """Fetch last 7 days for NCR; align to 64x64; save .pt."""
    get_gee_client()
    cfg = load_roi_config()
    roi = cfg["roi"]
